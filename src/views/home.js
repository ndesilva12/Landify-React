  ...
  return (
    <div className="home-container10">
      <Helmet>
        ...
        <link rel="canonical" href="https://landify-cu110n.teleporthq.app/" />
      </Helmet>
      ...
      <a href="https://play.teleporthq.io/signup" className="home-link9">
        <div aria-label="Sign up to TeleportHQ" className="home-container42">
          <svg
            width="24"
            height="24"
            viewBox="0 0 19 21"
          ...
          <span className="home-text51">Built in TeleportHQ</span>
        </div>
      </a>
    </div>
  )
